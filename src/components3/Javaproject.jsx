  ...
  const items2 = [
    {
      key: "1",
      label:
        "Am I eligible for this JAVA project?",
      children: (
        <div>
    ...
    {
      key: "2",
      label: "After the enrollment when will the JAVA batch start?",
      children: (
        <div>
          <div className="border-l-4 border-[#49adcc] p-2 answer text-base pl-3 bg-[#49adcc8f]">
          After enrolling our trainer will contact you and guide you in the procedure and as per your comfort and timings will schedule the classes.
          </div>
        </div>
      ),
    },
    {
      key: "3",
      label: "How much time does it take to complete the JAVA project?",
      children: (
        <div>
          <div className="border-l-4 border-[#49adcc] p-2 answer text-base pl-3 bg-[#49adcc8f]">
    ...
    },
    {
      key: "4",
      label:
        "Can we do the JAVA project on our own?",
      children: (
        <div>
          <div className="border-l-4 border-[#49adcc] p-2 answer text-base pl-3 bg-[#49adcc8f]">
    ...
    },
    {
      key: "5",
      label:
        "Is it hard to learn and complete the Final Year Project project in JAVA?",
      children: (
        <div>
          <div className="border-l-4 border-[#49adcc] p-2 answer text-base pl-3 bg-[#49adcc8f]">
          It is not so hard to complete the JAVA project. If we understand the basic principles then it is very easy to complete it.
          </div>
        </div>
      ),
    },
    {
      key: "6",
      label: "Do we need to join as a team or individually?",
      children: (
        <div>
          <div className="border-l-4 border-[#49adcc] p-2 answer text-base pl-3 bg-[#49adcc8f]">
...
<Row className=' m-0 '>
  ...
  <h1 className='text-white FirstHeading '>Final Year Projects in JAVA</h1>
...
<Container className='mb-5 cseContainer1' >
      <Row>
        <Col><h2  className="text-center font-semibold  mt-5 cseTitle1" >Do Your Own Final Year  Projects In JAVA</h2></Col>
      </Row>
      <Row>
...
<li className='mt-4'>We guide you in mini projects for engineering students and all other CSE departments.</li>
<li className='mt-3'>We support to implement the JAVA based final year projects.</li>
...
<Col lg={6}>
<p className='cseList2'><FaCircleCheck className='check'  />Management System Applications.</p>
<p className='cseList2'><FaCircleCheck className='check'  />Web Based Application using JSP.</p>
<p className='cseList2'><FaCircleCheck className='check'  />Android based mobile Application.</p>
</Col>
<Col lg={6} className='mb-4'>
<p className='cseList2'><FaCircleCheck className='check' />Web Server Management system.</p>
<p className='cseList2'><FaCircleCheck className='check' />Data Analyzing & Visualizing Applications.</p>
<p className='cseList2'><FaCircleCheck className='check' />OT Based Projects.</p>
</Col>
</Row>
...
<div className="content">
  <h5>Final Year Projects In JAVA</h5>
