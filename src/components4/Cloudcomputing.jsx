...
<Row className=' m-0 '>
  ...
  <h1 className='text-white FirstHeading '>Cloud Computing Projects for Final Year students</h1>
...
<Container className='mb-5 cseContainer1' >
      <Row>
        <Col><h2  className="text-center font-semibold  mt-5 cseTitle1" >Do Your Own Cloud Computing Final Year  Projects</h2></Col>
      </Row>
      <Row>
        <Col><p className="text-center mt-4 csePara1">Final year projects in mobile application development offer students the freedom to explore their own ideas and creativity. With guidance and support, students are encouraged to take their ideas and bring them to life through implementation. It is always better to try and take action rather than not doing anything at all.</p></Col>
      </Row>
...
<Row className='mt-5'>
 ...
 <li className='cseList1 mt-3'>We will be having our projects we will be training you to work in a live project, Execute, get succeeded with the support.</li>
    ...
    <Container fluid className='cseContainer2 mt-5 '>
     <Container >
<Row>
  <h2 className='cseTitle3 mt-5'>Cloud Computing Projects<span className='span1'>We Support</span> </h2>
<li className='mt-4'>We guide you in Cloud Computing projects.</li>
<li className='mt-3'>We support to implement the Cloud based final year projects.</li>
...
<Col lg={6}>
<p className='cseList2'><FaCircleCheck className='check'  />Cloud based Datamining & Data Warehouse.</p>
<p className='cseList2'><FaCircleCheck className='check'  />Cloud based Management System.</p>
<p className='cseList2'><FaCircleCheck className='check'  />Remote controlling smart devices using Cloud.</p>
</Col>
<Col lg={6} className='mb-4'>
<p className='cseList2'><FaCircleCheck className='check' />Mobile Application using Cloud.</p>
<p className='cseList2'><FaCircleCheck className='check' />Resource Management & Service Oriented Application in Cloud.</p>
<p className='cseList2'><FaCircleCheck className='check' />Secure Data Storage & Recovery Systems.</p>
</Col>
</Row>
...
<Row>
<h2>Cloud Computing Courses With Project</h2>
<p className='android mt-4'>Our Cloud Computing courses are designed to provide students with the latest knowledge and skills in this rapidly evolving technology. Each course is taught by a dedicated trainer who provides personalized instruction. We begin with the fundamentals and provide an overview of the course before diving into specific topics.</p>
<p className='android mt-4'>Through hands-on tasks and practical exercises, students gain valuable practical knowledge that prepares them for real-world work. By completing our lively and interactive training, students are well-equipped to enter the workforce without the need for additional training. This increases their chances of securing positions in multinational companies.</p>
</Row>
...
<div className="content">
  <h5>Cloud Computing Projects For Final Year</h5>
...
<Container className='mt-5'>
  <Row>
    <h2 className='text-center'>Why <span className='span1'>Kitkat Software Technologies?</span></h2>
